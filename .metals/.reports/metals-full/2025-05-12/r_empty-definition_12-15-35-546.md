error id: `<none>`.
file://wsl.localhost/Ubuntu/home/eaj123/Isabellm/Test/src/main/scala/sledgehammer.scala
...
offset: 5066
uri: file://wsl.localhost/Ubuntu/home/eaj123/Isabellm/Test/src/main/scala/sledgehammer.scala
text:
```scala
       ...
       fun go_run (state, thy) =
          let
             ...
             val params = ${Sledgehammer_Commands}.default_params thy
                [("provers", "['zipperposition', 'e']"),("timeout","60"),("verbose","true"), ("slices", "96"), ("max_proofs", "1")];
           ...
           in
             (result, (${Sledgehammer}.short_string_o@@f_sledgehammer_outcome outcome, [YXML.content_of step]))
           end;
    in
      Timeout.apply (Time.fromSeconds 65) go_run (state, thy) end
""".stripMargin
        )
